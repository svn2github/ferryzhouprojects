...
public class StampText {
    ...
    public static void stamp(String src, String dest, String text, String len, String len2)
        ...
        ColumnText.showTextAligned(canvas,
                Element.ALIGN_LEFT, new Phrase(text), (int)(w * (0.905 -Double.parseDouble(len2))), (int)(h * 0.035), 0);
		canvas.saveState();
		canvas.setColorStroke(BaseColor.BLACK);
		int defaultLen = (int)(w * 0.07);
		int lenInt = (int)(w * Double.parseDouble(len));
		canvas.rectangle((int)(w * (0.90 -Double.parseDouble(len2))), (int)(h * 0.03), lenInt, (int)(h * 0.025));
		canvas.stroke();
		canvas.saveState();
        stamper.close();
    }
